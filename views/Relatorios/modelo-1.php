...
<div class="row">    
    ...
    <a href="~/new_elementar/Modulo/home" 
      ...
      <a href="~/new_elementar/Relatorios/respostas_parciais" 
      class="btn btn-success btn-lg active" style="width: 280px;" role="button">Questões de Sim/Parcialmente</a>
  </center>   
</div>
<p><h2>Questões referentes as respostas Sim/Não</h2></p>
...
<div class="row">    
    ...
    <div id="graficos_professores<?= $i ?>" style="width: 1050px; height: 300px;"></div>
                  ...
                  var data = google.visualization.arrayToDataTable([
                    ...
                    <?php for ($j=0; $j < count($dadosGeral); $j++) { ?>
                        <?php if($questaoView[$i]->NomeQuestao == $dadosGeral[$j]["questao"]): ?>                      
                            ['<?= $dadosGeral["$j"]["curso"] ?>', <?= $dadosGeral[$j]["valor"] ?>],
                        <?php endif; ?>
                    <?php } ?>                                
                  ]);
